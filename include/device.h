...
{
public:
    GW_Touch_Area(GW_Platform_Rect &bound_rect, GW_Platform_EventID_Keys mapped_key) {
        bound_rect_ = bound_rect; mapped_key_ = mapped_key;
    };
    bool matches_finger(GW_Platform_Point finger);
    GW_Platform_EventID_Keys mapped_key_get() { return mapped_key_; }
    GW_Platform_Rect get_bound_rect() { return bound_rect_; }

    ~GW_Touch_Area();

private:
    GW_Platform_Rect bound_rect_;
    GW_Platform_EventID_Keys mapped_key_;
};

class GW_Game
{
public:
    //typedef list<GW_Touch_Area*> touch_maps_t;
    enum defkeys_t
    {
        //DK_ON,
        //DK_OFF,
    ...
    bool match_touch(GW_Platform_Event* event);
...
protected:
    ...
    void touch_map_add(GW_Touch_Area* touch_area) { touch_map_.push_back(touch_area); }
private:
    GW_GameData data_;
    ...
    GW_Device *device_;
    bool changed_;
    vector<GW_Touch_Area*> touch_map_;
};
