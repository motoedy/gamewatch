...
#define GW_PLATFORM_FPOINT(ps, px, py) \
    GW_Platform_FPoint ps; ps.x=px; ps.y=py;
...
struct GW_Platform_Event
{
    ...
    int data;
    GW_Platform_Point translated_point;
    GW_Platform_FPoint raw_point;
};
...
public:
    ...
    virtual GW_Platform_Point translate_touch_coordinates(GW_Platform_FPoint* touch) = 0;
...
#ifdef GW_DEBUG
    virtual void draw_touch(const char* log, GW_Platform_Point* touch) = 0;
#endif
private:
	string datapath_;
};
