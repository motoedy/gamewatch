    ...
    GW_GameEngine_VTech(engineoptions), options_(options)
{
    ...
    int RIGHT=40;
    int DOWN=55;
    GW_PLATFORM_RECT(BTN_LEFT, 40+RIGHT, 211+DOWN, 52, 52);
    GW_PLATFORM_RECT(BTN_RIGHT, 468+RIGHT, 211+DOWN, 52, 52);
    GW_PLATFORM_RECT(BTN_SET, 225+RIGHT, 300+DOWN, 27, 27);
    GW_PLATFORM_RECT(BTN_GAME_A, 273+RIGHT, 300+DOWN, 47, 29);
    GW_PLATFORM_RECT(BTN_GAME_B, 333+RIGHT, 300+DOWN, 47, 29);
    GW_PLATFORM_RECT(BTN_TIME, 392+RIGHT, 300+DOWN, 47, 29);
    GW_PLATFORM_RECT(DBG_RECT, 2, 2, 636, 476);

    touch_map_add(new GW_Touch_Area(BTN_LEFT, GPK_LEFT));
    touch_map_add(new GW_Touch_Area(BTN_RIGHT, GPK_RIGHT));
    touch_map_add(new GW_Touch_Area(BTN_SET, GPK_TURNON));
    touch_map_add(new GW_Touch_Area(BTN_GAME_A, GPK_GAMEA));
    touch_map_add(new GW_Touch_Area(BTN_GAME_B, GPK_GAMEB));
    touch_map_add(new GW_Touch_Area(BTN_TIME, GPK_TIME));
    touch_map_add(new GW_Touch_Area(DBG_RECT, GPK_ZOOM_DEVICE));
